namespace VulkanSharp.Raw {
	public unsafe static partial class Vk {
		...
		public enum VkFormatFeatureFlags {
			...
			FormatFeatureAccelerationStructureVertexBufferBitKhr = 0x20000000,
		...
		public enum VkPipelineStageFlags {
			...
			PipelineStageRayTracingShaderBitKhr = 0x00200000,
			PipelineStageAccelerationStructureBuildBitKhr = 0x02000000,
			...
			PipelineStageCommandPreprocessBitNv = 0x00020000,
		...
		public enum VkBufferUsageFlags {
			...
			BufferUsageRayTracingBitKhr = 0x00000400,
		...
		public enum VkPipelineCacheCreateFlags {
			PipelineCacheCreateExternallySynchronizedBitExt = 0x00000001,
			PipelineCacheCreateFlagBitsMaxEnum = 0x7fffffff,
		}
		public enum VkPipelineCreateFlags {
			...
			PipelineCreateRayTracingNoNullAnyHitShadersBitKhr = 0x00004000,
			PipelineCreateRayTracingNoNullClosestHitShadersBitKhr = 0x00008000,
			PipelineCreateRayTracingNoNullMissShadersBitKhr = 0x00010000,
			PipelineCreateRayTracingNoNullIntersectionShadersBitKhr = 0x00020000,
			PipelineCreateRayTracingSkipTrianglesBitKhr = 0x00001000,
			PipelineCreateRayTracingSkipAabbsBitKhr = 0x00002000,
			...
			PipelineCreateIndirectBindableBitNv = 0x00040000,
			PipelineCreateLibraryBitKhr = 0x00000800,
			PipelineCreateFailOnPipelineCompileRequiredBitExt = 0x00000100,
			PipelineCreateEarlyReturnOnFailureBitExt = 0x00000200,
		...
		public enum VkRenderPassCreateFlags {
			RenderPassCreateTransformBitQcom = 0x00000002,
		...
		public enum VkAccessFlags {
			...
			AccessAccelerationStructureReadBitKhr = 0x00200000,
			AccessAccelerationStructureWriteBitKhr = 0x00400000,
			AccessShadingRateImageReadBitNv = 0x00800000,
			AccessFragmentDensityMapReadBitExt = 0x01000000,
			AccessCommandPreprocessReadBitNv = 0x00020000,
			AccessCommandPreprocessWriteBitNv = 0x00040000,
		...
		public enum VkGeometryFlagsKHR {
			GeometryOpaqueBitKhr = 0x00000001,
			GeometryNoDuplicateAnyHitInvocationBitKhr = 0x00000002,
			...
			GeometryFlagBitsMaxEnumKhr = 0x7fffffff,
		}
		public enum VkGeometryInstanceFlagsKHR {
			GeometryInstanceTriangleFacingCullDisableBitKhr = 0x00000001,
			GeometryInstanceTriangleFrontCounterclockwiseBitKhr = 0x00000002,
			GeometryInstanceForceOpaqueBitKhr = 0x00000004,
			GeometryInstanceForceNoOpaqueBitKhr = 0x00000008,
			...
			GeometryInstanceFlagBitsMaxEnumKhr = 0x7fffffff,
		}
		public enum VkBuildAccelerationStructureFlagsKHR {
			BuildAccelerationStructureAllowUpdateBitKhr = 0x00000001,
			BuildAccelerationStructureAllowCompactionBitKhr = 0x00000002,
			BuildAccelerationStructurePreferFastTraceBitKhr = 0x00000004,
			BuildAccelerationStructurePreferFastBuildBitKhr = 0x00000008,
			BuildAccelerationStructureLowMemoryBitKhr = 0x00000010,
			...
			BuildAccelerationStructureFlagBitsMaxEnumKhr = 0x7fffffff,
		}
		...
		public enum VkIndirectStateFlagsNV {
			IndirectStateFlagFrontfaceBitNv = 0x00000001,
			IndirectStateFlagBitsMaxEnumNv = 0x7fffffff,
		}
		public enum VkIndirectCommandsLayoutUsageFlagsNV {
			IndirectCommandsLayoutUsageExplicitPreprocessBitNv = 0x00000001,
		...
		public enum VkDeviceDiagnosticsConfigFlagsNV {
			...
			DeviceDiagnosticsConfigEnableResourceTrackingBitNv = 0x00000002,
			DeviceDiagnosticsConfigEnableAutomaticCheckpointsBitNv = 0x00000004,
			DeviceDiagnosticsConfigFlagBitsMaxEnumNv = 0x7fffffff,
		}
	}
}
